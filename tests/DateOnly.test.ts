...
describe('DateOnly', () => {
    it('DayOfWeek is returning incorrect value', () => {
        assert.equal(new DateOnly(1, 1, 1900).DayOfWeek, 2);
        assert.equal(new DateOnly(1, 2, 1900).DayOfWeek, 3);
        assert.equal(new DateOnly(1, 7, 1900).DayOfWeek, 1);
        assert.equal(new DateOnly(1, 8, 1900).DayOfWeek, 2);
